PLS = function () {
	...
	vs1= [[-50, 50], [-50, -50], [50, -50], [50, 50]]
	vs2= [[-100, 0], [-100, -100], [0, -100], [0, 0], [-98, 2]]
	W(50)
	...
	_.in(function(){
		...
		//w.pol([500, 200, p1.U(p2)], [600, 200, p1.D(p2)], [700, 200, p1.I(p2)], [800, 200, p1.X(p2)])
...
} //fixture changes color on its own
BINDSPR = function () {
	BINDSPP = function () {
		W()
