...
cjs.cir = function () {var g = G(arguments), o, h,gx
    alert('cjs.cir')


    o= g.S_?

    {c: g.f, x: g.s, y: g.t, r: g[3]}:
...
h.bs= function(){var h=this, gx=h.graphics, g=G(arguments)
...
h.bsV=  function(o){var h=this, g=G(arguments), o
    o = g.A? {hs:g.f}:  g.f || {}
    o.hs = o.hs||[]
    o.i = o.i || 'me'
...
h.bfV= h.bV=function(o){var h=this, g=G(arguments), o
    o = g.A? {hs:g.f}:  g.f || {}
    o.hs = o.hs||[]
    o.i = o.i || 'me'
...
BMF=function(){W()._(function(){
    ...
    //h.bC
    w.i.h({x:50, y:200, bf: 'chicks'}, '+')
        .dc( {r:80}, {r:50, x:100}, {r:100, x:400} )



    //h.bf
    w.i.h(800, 100, '+').bf('guy')
        .dc( [ 80 ], [90, 0, 68] )
...
w.rec= w.box=w.bi = w.rect = w.X= function (x, y, W, H, c) {var w=this, g=G(arguments),b,o
    ...
    o = g.O?g.f:
        N(g.s)? {x:g.f, y:g.s, w:g.t, h:g[3], c:g[4]}: {w:g.f}
...
ct.rec=function(){var ct=this, g=G(arguments), o, ct2, h
    ...
    o =  g.S_ ? { c:g.f, w:g.s, h:g.t, x:g[3], y:g[4], rt:g[5] }:
        ...
        g.N_? { w:g.f, h:g.s, x:g.t, y:g[3], rt:g[4] }:
