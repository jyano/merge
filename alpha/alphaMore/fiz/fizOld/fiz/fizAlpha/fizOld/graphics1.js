...
cjs.cir = function () {var g = G(arguments), o= S(g[0]) ? {c: g[0], x: g[1], y: g[2], r: g[3]} :
    {x: g[0], y: g[1], r: g[2]}
    o.c = o.c || 'y'
    o.x = N(o.x);o.y = N(o.y);o.r = N(o.r, 100)
...
h.bV=function(o){var h=this
    ...
    $.i(o.i, function(i){
        h.bf(i[0])
        _.e(o.v, function(v){h.lt(v)})//.cp()//h.ef()
    })
    return h
}
...
h.bmR= h.bR=function(o){var h=this;
    h.bf(o, function(h1){ h.rec(h1) })  /*
...
w.bmR=function(){var w=this, b, h,g=G(arguments),o
    o = S(g.t)?
    {x:g.f, y:g.s, c: g.t, w:g[3], h:g[4]}:
