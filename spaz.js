...
function bods(){
    ...
    b.__f=function(f){var b=this, g=G(arguments)
    ...
    b.cir= function(){var b=this, g=G(arguments), 
    ...
    fd,  h,  f 
        ...
        if(O(g.s)){ g.e(function(c){b.cir(c) }); return b }
    ...
    w.D=function(){var w=this, g=G(arguments,'k'),o,
    b
