C$  =createjs
T$  =C$.Ticker
createjs.spriteSheet = SS$  =function(a){return new C$.SpriteSheet(a)}
//S$  =function(a){return new createjs.Stage(a)}
createjs.loadQueue =Q$  =function(){return new C$.LoadQueue(true)}
createjs.tween = W$  =C$.Tween
createjs.container = Ct$  =function(a){return new C$.Container(a)}
createjs.DOMElement =D$   =function(){return C$.DOMElement}
createjs.graphics =G$   =function(a){return new C$.Graphics(a)}
createjs.shape = H$=function(a){ return new createjs.Shape(a) }
createjs.bm = B$=function(a){ return new createjs.Bitmap(a) }
createjs.sprite = EaselSprite= J$=function(spriteSheet){
