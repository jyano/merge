...
Bb.C.x= function(a,b,c){
    a=a||{}; return bb.C.extend(a,b,c) }
Bb.C.x= Bb.C.e=function(ob){var g=G(arguments), o,Cl //o= g.F_? {fn: g.f, ob: g.s} : {ob: g.f, fn: g.s}; o=o||{}
    ob=ob||{} /*
     if(o.fn){ob.i= o.fn}
    ...
    Cl= bb.C.extend(ob)
    Cl.o=function(ob, q){var Cl = this, cl
        if(U(ob)){return new Cl} //ob=ob||{}
        ob.collection= ob.collection || ob.cl || ob.c
        ob.model = ob.model || ob.md || ob.m
        cl= new Cl(ob)
        //if(q){cl.a2(q)}
