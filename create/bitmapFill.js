...
TXB = function () {
	...
	$St()._(function(st){
		...
		i = Q.i('me')
		h= st.h('+')
		h._bfT(i, -100).dr(0,0,500,200)  //.dr(100, 100, 500, 200)
		h.C('z').dr(0,0, 40, 40)
...
h.bf1 = function () {var h = this, gx = h.graphics, g = G(arguments), o
...
h.bf = function () {var h = this, gx = h.graphics, g = G(arguments), o
	...
	if(!Q.ran && S(o.i)) { $.i(o.i, function (i) {_bf(i, o.mx, o.fn)}) }
	else { _bf(S(o.i) ? Q.i(o.i) : o.i, o.mx, o.fn)}
	return h
	
	
	function _bf(i, mx, fn, hs) {
		h._bf(i, o.mx);
		o.hs ? _.e(o.hs, function (shp) {o.fn(shp, h)}) : o.fn(h)
	}
