...
$Bm = cjs.B = cjs.bm = function () {
	var g = G(arguments), i = g[0], bm
	bm = new cjs.Bitmap(i)
	if (g.p) {
		bm.drag()
	}
...
preload = function () {
	...
	q.m = function () {
		var q = this, g = G(arguments), _mf, mf
		// q.m:
// protosig:
//
// 'me',..
...
container = function () {
	...
	ct.bm = ct.b = function self(i, sc, fn) {
...
later = function () {
	...
	ICEN = function () {
		Q(['guy', 'me'], function () {//z()
			s = new cjs.Stage($.can('p', 1200, 600)[0]).A();
			s.c = $(s.canvas)
